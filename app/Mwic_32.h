...
{
//**********************    commual subroutine    ***********************
HANDLE __stdcall usb_ic_init();
HANDLE __stdcall usb_auto_init();
__int16 __stdcall usb_ic_exit(HANDLE icdev);
__int16 __stdcall usb_get_reader_list(unsigned char *reader_list,
									  unsigned char *reader_count);
HANDLE __stdcall usb_select_reader(unsigned char reader_number);
HANDLE __stdcall ic_init(__int16 port,unsigned long baud);
HANDLE __stdcall auto_init(__int16 port,long baud);
